...
class DataIngestion:
    ...
    def download_dataset(self):
        try:
            ...
            logging.info(
                f"Dataset '{self.dataset_name}' downloaded and saved to '{self.save_folder}'.")
            logging.info(f"Train dataset saved to '{train_folder}'.")
            logging.info(f"Test dataset saved to '{test_folder}'.")
