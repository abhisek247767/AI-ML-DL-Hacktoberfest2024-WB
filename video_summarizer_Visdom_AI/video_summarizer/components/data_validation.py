    ...
    def check_dataset(self):
        try:
            ...
            if required_train_file not in train_files:
                raise ValueError(
                    f"Required file '{required_train_file}' not found in the train set.")
            ...
            if required_test_file not in test_files:
                raise ValueError(
                    f"Required file '{required_test_file}' not found in the test set.")
            ...
            logging.error(f"Exception occurred during data validation: {e}")
